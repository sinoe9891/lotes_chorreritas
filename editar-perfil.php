...
<div class="contenedor-formulario">
	...
	if (isset($_GET['nombres']) || isset($_GET['clase']) || isset($_GET['apellidos']) || isset($_GET['genero']) || isset($_GET['nacionalidad'])) {
		...
		$genero = $_GET['genero'];
		$consulta = $conn->query("SELECT * FROM graduat3s WHERE nombres LIKE '%$nombres%' AND apellidos LIKE '%$lastname%' AND genero LIKE '%$genero%' AND clase LIKE '%$clase%' AND codigo LIKE '%$codigo%' AND nacionalidad LIKE '%$nacionalidad%' ORDER BY nombres ASC");
