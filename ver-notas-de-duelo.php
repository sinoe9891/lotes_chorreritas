					...
					<div class="colum-second" style="display: flex;justify-content: center;">
						<div class="input" >
							<div class="campo">
								...
								<input type="number" class="anoFallecido" name="anoFallecido" required id="anoFallecido" placeholder="Año en que Fallecido" min="1979" max="<?php echo date('Y');?>" value="<?php echo date('Y');?>">
							</div>
						</div>
						</div>
