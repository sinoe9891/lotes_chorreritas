...
<strong>FERNANDO ANTONIO BAIRES P.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' . $nombreCompleto . '</strong>
<strong>PROMITENTE VENDEDOR</strong><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PROMITENTE COMPRADOR.</strong>
			...
			try {
				...
				$mpdf->WriteHTML($html);
				$mpdf->Output("galeria/Nota de Duelo " . ucwords(strtolower($nombre)) . ".pdf", "I");
				$mpdf->Output("galeria/Nota de Duelo " . ucwords(strtolower($nombre)) . ".pdf", "F");
