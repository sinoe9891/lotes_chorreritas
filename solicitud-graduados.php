						...
						<form id="formulario-solicitud" method="post">
							...
							<div class="colum-second">
								...
								<div class="input">
									<div class="campo">
										...
										<!-- <input type="text" name="pais_reside" id="pais" value="" placeholder="País donde vive" required> -->
							...
							<div class="colum-second">
								<div class="input">
									<div class="campo">
										...
										<input type="text" name="ciudad" id="ciudad" value="" placeholder="Ciudad donde vive">
									</div>
								</div>
								<div class="input">
									<div class="campo">
							...
							<div class="colum-second">
								...
								<div class="input">
									<div class="campo">
										...
										<input type="tel" name="empresa_labora" id="empresaLabora" value="" placeholder="Empresa donde labora" required>
									</div>
								</div>
							</div>
							...
							<div class="campo enviar registro">
								<div class="boton-registro">
									...
									<input type="submit" value="Solicitar actualización" name="update">
								</div>
							</div>
						</form>
					</div>
