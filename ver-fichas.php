		...
		<div class="caja-ficha">
			<div class="img-formulario">
				...
				<div style="display: flex;justify-content: space-around;flex-wrap: wrap;">
					<form id="solicitudes" method="get" action="ver-fichas.php">
						<div class="titulo-form">
					...
					<form id="solicitudes" method="get" action="exportar/exportar-ver-fichas.php">
						<div class="titulo-form">
							<div class="inputs-search">
								<div class="input">
									<div class="campo">
						...
						?>
							<tr id="solicitud:<?php echo $solicitud['id'] ?>">
								...
								<td>
									...
									<input type="hidden" id="nombre" value="<?php echo $solicitud['nombre_completo'] ?>">
								</td>
								<td>
									<div class="acciones">
