...
<div class="contenedor-formulario">
	...
	<div class="contenedor-login">
		<div class="caja-register">
			...
			if($_GET){
				$solicitudes = obtenerInfoSolicitudGraduando($user_id);
			}else{
			...
			if ($solicitudes->num_rows > 0) {
				while ($row = $solicitudes->fetch_assoc()) {
					...
					//Datos Actuales
					$infoActual = obtenerInfoGraduandosActual($id);
					if ($infoActual) {
			...
			?>
							<div class="formulario">
								<form id="form-aprobacion-graduando" method="post">
									...
									<div class="colum-second">
										<div class="input1">
											<div class="titulos">
												<p>Rubro de la empresa donde labora:</p>
											</div>
											<div class="campo campo2">
												<div class="icon">
