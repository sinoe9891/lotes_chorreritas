				...
				while ($row = $solicitudes->fetch_assoc()) {
					...
					<div class="formulario">
						<form id="editarGraduado" method="post">
							...
							<div class="colum-second">
								...
								<div class="input">
									<div class="campo">
										...
										<select name="fallecido" id="fallecido" onchange='opcionFallecido()'>
											<?php
											if ($fallecido == 1) {
												echo '<option value="0" id="0">NO</option>
										 <option value="1" id="1" selected>SI</option>';
											} else {
												echo '<option value="0" id="0" selected>NO</option>
										<option value="1" id="1">SI</option>';
											} ?>
							...
							<div class="colum-second" style='display:none;' id='fallecidoInput'>
								<div class='input'>
									<div class="campo">
										<div class="icon">
											<i class="fas fa-cross"></i>
										</div>
										<input type="date" class="fechaFallecido" name="fechaFallecido" id="fechaFallecido" value="<?php echo $fechaFallecido; ?>">
									</div>
								</div>
								<div class="input">
									<div class="campo">
										...
										<input type="date" class="fechaNotaDuelo" name="fechaNotaDuelo" id="fechaNotaDuelo" value="<?php if ($fechaNotaDuelo == "0000-00-00") {
							...
							<div class="colum-second">
								...
								<div class="input">
									<div class="campo">
										...
										<input type="tel" name="empresa_labora" id="empresaLabora" value="<?php echo $empresa_labora; ?>" placeholder="Empresa donde labora">
									</div>
								</div>
							</div>
							...
							<div class="colum-second">
								<div class="input">
									<div class="campo">
										...
										<input type="text" name="rubro_empresa_pasantia" value="<?php echo $rubro_empresa_pasantia; ?>" id="rubroEmpresaPasantia" placeholder="Rubro de la empresa de pasantía">
									</div>
								</div>
								<div class="input">
									<div class="campo">
							...
							<div class="colum-second">
								<div class="input" style="width: 100% !important">
									<div class="campo" style="width: 100% !important;width: 100% !important;display:flex;justify-content: center;">
										<?php
