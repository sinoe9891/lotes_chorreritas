...
$linkedin = $_POST['linkedin'];
$fallecido = $_POST['otras_entidades'];
...
if ($accion === 'solicitud') {
    ...
    try {
        $stmt = $conn->prepare("INSERT INTO temporal_update_210618 (fecha_solicitud, hora_solicitud, ID, clase, codigo, nombres, primer_nombre, segundo_nombre, apellidos, primer_apellido, segundo_apellido, nickname, nacionalidad, genero, fecha_nacimiento, pais_reside, ciudad, direccion, email, email_2, email_3, telefono, movil, empresa_labora, rubros, programa, orientacion, lugar_pasantia, direccion_pasantia, rubro_empresa, exp_pasantia, area_investigacion, titulo_tesis, asesor_tesis, url_tesis, area_interes, financiado_por, linkedin, url_linkedin, otras_entidades, fondos_zamorano, fondos_propios,fondos_entidades,deceased, date_deceased, estatus, pa, anioIA, dia_graduacion, mes_graduacion, codigoIA) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        $stmt->bind_param('sssssssssssssssssssssssssssssssssssssssssssssssssss', $fechaSolicitud, $horaSolicitud, $user_id, $class, $codigo, $name, $firstname, $secondname, $lastname, $primer_apellido, $segundo_apellido, $nickname, $nationality, $sex, $hddate, $country, $city, $address, $correo, $correo1,$correo2, $phone, $mobile, $empresaLabora, $rubroEmpresaLabora, $programa, $orientation, $empresaPasantia, $direccionEmpresaPasantia, $rubroEmpresaPasantia, $experienciaPasantia, $areaInvestigacionPasantia, $tituloTesis, $asesorTesis, $urlTesis, $areasInteres, $financiado, $linkedin,$url_linkedin, $otras_entidades, $fondos_zamorano, $fondos_propios, $fondos_entidades, $fallecido, $fechaFallecido, $estatus, $pa, $anioIA, $dia_graduacion, $mes_graduacion, $codigoIA); 
        $stmt_counter = $conn->prepare("INSERT INTO temporal_update_counter (fecha_solicitud, hora_solicitud, ID, clase, codigo, nombres, primer_nombre, segundo_nombre, apellidos, primer_apellido, segundo_apellido, nickname, nacionalidad, genero, fecha_nacimiento, pais_reside, ciudad, direccion, email, email_2, email_3, telefono, movil, empresa_labora, rubros, programa, orientacion, lugar_pasantia, direccion_pasantia, rubro_empresa, exp_pasantia, area_investigacion, titulo_tesis, asesor_tesis, url_tesis, area_interes, financiado_por, linkedin, url_linkedin, otras_entidades, fondos_zamorano, fondos_propios,fondos_entidades,deceased, date_deceased, estatus, pa, anioIA, dia_graduacion, mes_graduacion, codigoIA) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        $stmt_counter->bind_param('sssssssssssssssssssssssssssssssssssssssssssssssssss', $fechaSolicitud, $horaSolicitud, $user_id, $class, $codigo, $name, $firstname, $secondname, $lastname, $primer_apellido, $segundo_apellido, $nickname, $nationality, $sex, $hddate, $country, $city, $address, $correo, $correo1,$correo2, $phone, $mobile, $empresaLabora, $rubroEmpresaLabora, $programa, $orientation, $empresaPasantia, $direccionEmpresaPasantia, $rubroEmpresaPasantia, $experienciaPasantia, $areaInvestigacionPasantia, $tituloTesis, $asesorTesis, $urlTesis, $areasInteres, $financiado, $linkedin,$url_linkedin, $otras_entidades, $fondos_zamorano, $fondos_propios, $fondos_entidades, $fallecido, $fechaFallecido, $estatus, $pa, $anioIA, $dia_graduacion, $mes_graduacion, $codigoIA); 
        $stmt->execute();
